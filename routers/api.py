...
from utils.db import (
    get_config, save_config, update_config_field,
...
# ══════════════════════════════════════════════
#   SETTINGS — Guardar config general
# ══════════════════════════════════════════════
...
async def save_general_settings(request: Request, guild_id: str, payload: GeneralSettingsPayload):
    ...
    config.update({
        ...
        "welcome_message":      payload.welcome_message[:500] if payload.welcome_message else "",
        "close_message":        payload.close_message[:500] if payload.close_message else "",
